...
var author$project$Port$Ignored = {$: 'Ignored'};
var author$project$Port$GotText = function (a) {
	return {$: 'GotText', a: a};
};
...
var author$project$Port$decodeDataValue = F2(
	function (dtype, data) {
		if ((dtype.$ === 'Ok') && (dtype.a === 'text')) {
			return A2(
				elm$core$Result$map,
				author$project$Port$GotText,
				A2(elm$json$Json$Decode$decodeValue, elm$json$Json$Decode$string, data));
		} else {
			return elm$core$Result$Ok(author$project$Port$Ignored);
		}
	});
...
var author$project$Port$decodeData = function (val) {
	var msg = A2(
	...
	var dtype = A2(
		elm$json$Json$Decode$decodeValue,
		A2(elm$json$Json$Decode$field, 'dtype', elm$json$Json$Decode$string),
		val);
	var data = A2(
		elm$json$Json$Decode$decodeValue,
	...
	return A2(
		...
		author$project$Port$Ignored,
		A2(
			elm$core$Result$andThen,
			author$project$Port$decodeDataValue(dtype),
			data));
};
var author$project$Port$question = _Platform_incomingPort('question', elm$json$Json$Decode$value);
var elm$core$Platform$Sub$map = _Platform_map;
var author$project$Main$subscriptions = function (model) {
	return A2(
		elm$core$Platform$Sub$map,
		author$project$Main$GotData,
		author$project$Port$question(author$project$Port$decodeData));
};
	...
	return elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'answer',
				elm$json$Json$Encode$string('answer here'))
			]));
};
var author$project$Main$updateData = F2(
	function (msg, model) {
		if (msg.$ === 'GotText') {
			var q = msg.a;
...
var author$project$Port$answer = _Platform_outgoingPort('answer', elm$core$Basics$identity);
	...
	function (msg, model) {
		switch (msg.$) {
			case 'GotData':
				var subMsg = msg.a;
				return _Utils_Tuple2(
					A2(author$project$Main$updateData, subMsg, model),
					elm$core$Platform$Cmd$none);
			case 'EditAnswer':
				var answer = msg.a;
				return _Utils_Tuple2(
			...
			default:
				return _Utils_Tuple2(
					model,
					author$project$Port$answer(
						author$project$Main$toJson(model)));
		}
	});
var author$project$Main$EditAnswer = function (a) {
...
var author$project$Main$view = function (model) {
	...
	if (_n0.$ === 'Just') {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							elm$html$Html$Events$onInput(author$project$Main$EditAnswer)
						]),
					_List_Nil)
				]));
	} else {
		return A2(
			...
			_List_fromArray(
				[
					elm$html$Html$text('No question yet')
				]));
	}
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"GotData":["Port.Msg"],"EditAnswer":["String.String"],"Reply":[]}},"Port.Msg":{"args":[],"tags":{"GotText":["String.String"],"Ignored":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));